    ...
    <div className="space-y-8">
      ...
      <div className="mt-8">
        ...
        {activeTab === 'moderation' && (
          <div className="card">
            <div className="card-header">
              <h3 className="card-title">🛡️ Student Upload Moderation</h3>
              <p className="card-description">Review and moderate student video submissions</p>
            </div>
            <div className="text-center py-12">
              <div className="bg-gradient-primary bg-opacity-10 rounded-full w-24 h-24 flex items-center justify-center mx-auto mb-6">
                <Shield className="h-12 w-12 text-primary" />
              </div>
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Moderation Dashboard</h4>
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                Review student video uploads, approve quality content, and help maintain educational standards.
              </p>
              <Link to="/moderation" className="btn-primary px-8 py-4 text-lg shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
